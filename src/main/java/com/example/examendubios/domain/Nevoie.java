...
public class Nevoie extends Entity<Long>{
    ...
    private Long omInNevoie,omSalvator;
    private String status;

    public Nevoie(Long aLong, String titlu, String descriere, LocalDateTime deadline, Long omInNevoie) {
        super(aLong);
        this.titlu = titlu;
    ...
    public Nevoie(Long aLong, String titlu, String descriere, LocalDateTime deadline, Long omInNevoie, Long omSalvator, String status) {
        super(aLong);
        this.titlu = titlu;
        this.descriere = descriere;
        this.deadline = deadline;
